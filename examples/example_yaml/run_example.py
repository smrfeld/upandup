...
@dataclass
class DataSchemaV1(DataClassYAMLMixin):
    """First version of the data schema.
    """    
    x: int

@dataclass
class DataSchemaV2(DataClassYAMLMixin):
...
@dataclass
class DataSchema(DataClassYAMLMixin):
...
for i,fname in enumerate(["version_DataSchemaV1.yaml", "version_DataSchemaV2.yaml", "version_DataSchema.yaml"]):
